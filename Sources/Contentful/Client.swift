...
extension Client {
    ...
    ///
    /// - Parameters:
    ///   - resourceType: A reference to the concrete ArrayResponse where the generic parameter is a Swift type which conforms to `Decodable & EndpointAccessible & ResourceQueryable`
    ...
    ///
    /// - Parameters:
    ///   - resourceType: A reference to the concrete ArrayResponse where the generic parameter is a Swift class conforming to `EntryDecodable`
    ...
    /// the completion callback will be a `MixedMappedArrayResponse` in which each element in the `items` array may be a different `EntryDecodable` type.
    ///
    /// - Parameters:
